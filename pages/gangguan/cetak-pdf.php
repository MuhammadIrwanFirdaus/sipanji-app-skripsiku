...
function createPDF($start_date, $end_date) {
    ...
    $selectSql = "SELECT * FROM gangguan WHERE tgl_masuk BETWEEN :start_date AND :end_date";
...
$pdf->Cell(60, 10, 'nama_tempat', 1, 0, 'C');
...
foreach ($pengajuan as $event) {
    ...
    $pdf->Cell(60, 10, $event['nama_tempat'], 1, 0, 'L');
...
$pdf->SetX(10);
    ...
    $pdf->Output('Laporan Data Gangguan.pdf', 'D');
    exit();
}
