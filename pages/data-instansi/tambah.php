...
if (isset($_POST['button_create'])) {
    ...
    $insertSQL = "INSERT INTO data_instansi (kategori, nama_instansi, nama_perwakilan, alamat, no_telpon, koordinat) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    <div class="containerfluid">
        <div class="row mb2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="?page=tampil-data-instansi">Data Instansi</a></li>
